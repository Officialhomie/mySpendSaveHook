...
contract HookFailureScenariosTest is Test, Deployers {
    ...
    function testHookFailure_ModuleNotInitialized() public {
        ...
        SpendSaveHook uninitializedHook = new SpendSaveHook{salt: salt}(IPoolManager(address(manager)), tempStorage);
    ...
    function testHookFailure_ComprehensiveFailureRecovery() public {
        ...
        SwapParams memory normalParams = SwapParams({zeroForOne: true, amountSpecified: -1 ether, sqrtPriceLimitX96: 0});
        ...
        SwapParams memory reverseParams =
        ...
        SwapParams memory smallParams =
            SwapParams({zeroForOne: true, amountSpecified: -0.001 ether, sqrtPriceLimitX96: 0});
        ...
        SwapParams memory largeParams = SwapParams({zeroForOne: true, amountSpecified: -10 ether, sqrtPriceLimitX96: 0});
