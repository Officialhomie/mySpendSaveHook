...
contract CriticalHookTests is Test, Deployers {
    ...
    function testBeforeSwapInternal_BasicFunctionality() public {
        ...
        assertEq(
            ...
            expectedDelta0,
            "Should calculate correct delta for INPUT savings"
        );
        ...
        assertEq(
            ...
            "Should set correct savings token type"
        );
    ...
    function testBeforeSwapInternal_EdgeCases() public {
        ...
        (bytes4 selector1, BeforeSwapDelta delta1, uint24 fee1) =
            hook._beforeSwapInternal(alice, poolKey_A_B, zeroParams, abi.encode(alice));
    ...
    function testBeforeSwapInternal_TransientStorageIntegrity() public {
        ...
        assertEq(
            uint8(setContext.savingsTokenType),
            uint8(SpendSaveStorage.SavingsTokenType.INPUT),
