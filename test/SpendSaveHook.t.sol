...
contract SpendSaveHookTest is Test, Deployers {
    ...
    function _configureAndValidateModuleReferences() internal {
        ...
        savingStrategyModule.setModuleReferences(address(savingStrategyModule), address(savingsModule), address(dcaModule), address(slippageControlModule), address(tokenModule), address(dailySavingsModule));
