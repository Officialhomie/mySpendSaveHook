...
contract ModuleAuthorizationTest is Test, Deployers {
    ...
    function testModuleAuth_UserAuthorizationPattern() public {
        ...
        vm.prank(attacker);
        strategyModule.setSavingStrategy(
            alice, 5000, 0, 0, false, SpendSaveStorage.SavingsTokenType.OUTPUT, address(tokenB)
        );
        ...
        vm.prank(alice);
        strategyModule.setSavingStrategy(
            alice, 1500, 0, 0, false, SpendSaveStorage.SavingsTokenType.OUTPUT, address(tokenB)
        );
