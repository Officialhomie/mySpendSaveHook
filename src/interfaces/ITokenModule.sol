...
interface ITokenModule is ISpendSaveModule {
     ...
     */
    function batchRegisterTokens(address[] calldata tokens) external returns (uint256[] memory tokenIds);
     ...
     */
    function mintSavingsToken(address user, uint256 tokenId, uint256 amount) external;
     ...
     */
    function batchMintSavingsTokens(address user, uint256[] calldata tokenIds, uint256[] calldata amounts) external;
     ...
     */
    function burnSavingsToken(address user, uint256 tokenId, uint256 amount) external;
     ...
     */
    function batchBurnSavingsTokens(address user, uint256[] calldata tokenIds, uint256[] calldata amounts) external;
     ...
     */
    function transfer(address from, address to, uint256 tokenId, uint256 amount) external returns (bool success);
     ...
     * @return success Whether the transfer succeeded
     */
    function transferFrom(address from, address to, uint256 tokenId, uint256 amount) external returns (bool success);
}
